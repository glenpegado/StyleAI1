...
Ensure you include both premium and affordable options. Use real brands and realistic prices. Make sure all URLs are valid and accessible.`,
    ...
    // Check if the response is a plain text error message
    if (
      !content.includes("{") ||
      ...
      // Try to generate a fallback outfit response
      const fallbackOutfit = {
        main_description: "A versatile casual outfit perfect for everyday wear",
        tops: [
          {
          ...
          },
          {
            ...
            description: "Soft cotton vintage-style graphic tee",
            price: "$35",
        ...
        bottoms: [
          {
            name: "Slim Fit Jeans",
            description: "Classic blue denim with comfortable stretch",
            price: "$79",
            brand: "Levi's",
            website: "LEVI'S",
          ...
          {
            name: "Chino Pants",
            description: "Versatile cotton chinos in khaki",
            price: "$45",
            brand: "Gap",
            website: "GAP",
        ...
        accessories: [
          {
            ...
            description: "Classic white canvas low-top sneakers",
            price: "$65",
            brand: "Converse",
            website: "CONVERSE",
        ...
        shoes: [
          ...
          {
            name: "Canvas Shoes",
            description: "Comfortable canvas slip-on shoes",
            price: "$55",
            brand: "Vans",
            website: "VANS",
      ...
      console.log("Returning fallback outfit due to AI service error");
      return NextResponse.json(fallbackOutfit);
    }
